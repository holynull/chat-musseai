...
Be precise and thorough in your analysis."""
    ...
    human_message = HumanMessage(content="""Please analyze the entire conversation history to determine if it contains any complete trading signals.
...
Provide your analysis and conclusion.""")
    ...
    if has_complete_signal:
        logger.info(f"Complete trading signal detected in conversation history - routing to backtest")
        ...
        human_message=HumanMessage(f"""Generate a new {state['symbol']} trading signal.
