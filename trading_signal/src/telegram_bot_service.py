...
class EnhancedTelegramBotService:
    ...
    def __init__(self, bot_token: str, chat_storage_file: str = "telegram_users.json"):
        ...
        self.initial_retry_delay = float(os.getenv("TELEGRAM_INITIAL_RETRY_DELAY", "1.0"))
        self.retry_backoff_factor = float(os.getenv("TELEGRAM_RETRY_BACKOFF_FACTOR", "2.0"))
        self.max_retry_delay = float(os.getenv("TELEGRAM_MAX_RETRY_DELAY", "30.0"))
        self.retry_jitter = bool(os.getenv("TELEGRAM_RETRY_JITTER", "True").lower() == "true")
...
_Automated Trading Signal System_
    ...
    def setup_bot_handlers(self):
        ...
        # Add message handler for mentions and replies
        self.application.add_handler(
    ...
    async def broadcast_signal(self, message: str, parse_mode: str = "Markdown") -> Dict[str, Any]:
