			...
			<div className="flex flex-col space-y-6 p-4 rounded-lg border border-gray-700 bg-gray-800 text-white max-w-3xl sm:mt-6 md:mt-8">
				<div className="bg-gray-900 rounded-lg p-4">
					<div className="flex items-center justify-between mb-3">
						<h3 className="text-xl font-semibold">SOL Balance</h3>
						<div className="flex items-center">
							<span className="text-sm text-gray-400 mr-2">Solana</span>
							<Image
					...
					{/* 主要余额信息 */}
					<div className="flex justify-between items-center p-3 bg-gray-800 rounded-lg border border-gray-700 mb-4">
						<div>
							<p className="text-sm text-gray-400">Current Balance</p>
							<p className="text-xl font-semibold text-white">
								{formatNumber(data.balance)}
								<span className="text-gray-400 text-base ml-1">SOL</span>
							</p>
						</div>
					</div>
					...
					{/* 钱包信息 */}
					<div className="mt-3">
						<h4 className="text-sm font-semibold mb-2">Wallet Info</h4>
						<div className="text-xs bg-gray-800 p-2 rounded overflow-hidden text-gray-300 border border-gray-700 hover:bg-gray-700 transition-all duration-200">
					...
					{/* 其他相关信息 */}
					<div className="mt-3">
						<h4 className="text-sm font-semibold mb-2">Market Info</h4>
